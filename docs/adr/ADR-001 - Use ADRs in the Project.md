# ADR-001: Use ADRs in the Project
...
Since the project currently has only one developer, there is a risk of
decisions being undocumented or becoming difficult to explain later. Adopting a
