...
to the production the version assigned to this commit should be incremented. This will be handled by TODO: calculateGitVersion node script that will increment the version based on
