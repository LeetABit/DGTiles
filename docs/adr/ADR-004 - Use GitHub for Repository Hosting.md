# ADR-004: Use GitHub for Repository Hosting
...
to set up and use, while also providing features that support future
scalability and potential team collaboration.
...
1. **Ease of Use**:
   ...
   easy to manage repositories and perform tasks such as pull requests and
   issue tracking.

2. **Popularity and Community**:
   GitHub is the most widely used Git hosting platform, ensuring familiarity
   for future collaborators and access to extensive community support and
   documentation.
...
access tokens for secure access, which introduces a minor initial configuration
effort.

2. The project will rely on an external platform for repository hosting,
meaning it is subject to GitHub’s terms of service and any potential service
disruptions.
...
### GitLab:
   - **Pros**: Strong CI/CD integration and robust free tier for private
     repositories.
   - **Cons**: Slightly less user-friendly for newcomers and smaller community
     compared to GitHub.
...
### Self-hosted Git Server:
   ...
   - **Cons**: Requires significant setup and maintenance effort, overkill for
