...
export interface ContainerProps<T extends HTMLElement = HTMLElement> {
     ...
     */
    fallbackContainer?: ReactElement;
...
export default function Container<T extends HTMLElement = HTMLElement>({
    ...
    if (fallbackContainer === undefined) {
        ...
        const a = extraAttributes as unknown as React.HTMLAttributes<HTMLDivElement>;
        //const e = extraAttributes as Optional<React.HTMLAttributes<HTMLDivElement>>;

        return <div css={extraStyle} {...extraProps} {...a}>{children}</div>;
    }
